...
const RESERVE_LEN: usize = 575; // 1 + 8 + 1 + 32 + 32 + 1 + 32 + 32 + (4 + 32) + 8 + 16 + 16 + 16 + 32 + 8 + 32 + 1 + 1 + 1 + 1 + 1 + 1 + 1 + 8 + 8 + 1 + 33 + 33 + 182
...
mod test {
    ...
    prop_compose! {
        fn collateral_exchange_rate_range()(percent in 1..=150u64) -> CollateralExchangeRate {
            CollateralExchangeRate(Rate::from_scaled_val(percent * PERCENT_SCALER))
        }
    }

    prop_compose! {
        fn generate_deposit_withdraw_sequence()(initial_deposit in 1u64..=100u64)
    ...
    proptest! {
        ...
        #[test]
        fn borrow_fee_calculation_weiwuui(
            ...
            borrow_amount in 0..=u64::MAX, // start at 3 to ensure calculation success
